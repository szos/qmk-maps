...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 TG(_CHORDS), KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_RBRACKET,
...
//                                    LSFT_TAB,LCTL_BSP,                       RCTL_SPC,RSFT_ENT, 
  ...
  [_CHORDS] = LAYOUT_6x6(
     ...
     KC_F1  , KC_F2 , KC_F3 , KC_F4 , KC_F5 , KC_F6 ,                         KC_F7 , KC_F8 , KC_F9 ,KC_F10 ,KC_F11 ,KC_F12 ,
     KC_ESC ,CRD_1_6,CRD_2_7,CRD_3_8,CRD_4_9,CRD_5_0,                         KC_6  , KC_7  , KC_8  , KC_9  , KC_0  ,KC_BSPC,
     KC_RBRC, KC_NO ,CRD_COM,CRD_ALT,CRD_RLT, KC_NO ,                         KC_Y  , KC_U  , KC_I  , KC_O  , KC_P  ,KC_MINS,
     KC_NO  ,KC_CD_1,KC_CD_2,KC_CD_3,KC_CD_4,CRD_DSH,                       KC_H  , KC_J  , KC_K  , KC_L  ,KC_SCLN,KC_QUOT,
 TG(_CHORDS), KC_NO ,CRD_DOT,CRD_CTL,CRD_SFT,CRD_QOT,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
                     KC_NUBS,KC_NUHS ,                                                       KC_PLUS, KC_EQL,
                                      KC_CD_5,KC_ENT,                         KC_ENT, KC_BSPC,
                                      KC_TAB, KC_BSPC,                         KC_END,  KC_DEL,
                                      KC_B , CRD_GUI,                        KC_LGUI, KC_LALT
  ),
