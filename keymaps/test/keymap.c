...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_6x6(
     ...
     KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_RBRACKET,
                      KC_LBRC,KC_RBRC,                                                       KC_MINS, KC_EQUAL,
                                      KC_TAB, KC_DEL,                         KC_BSPC, KC_SPC,
                                      KC_LCTRL,KC_LALT,                       RALT_RET, KC_RCTRL,
                                      KC_LGUI, KC_MENU,                       KC_RGUI, KC_MENU
  ),
