...
enum my_keycodes {
  ...
  // regular keys
  LALT_PO, LALT_PC,
  /* swap bsp and tab on LSFT and LCTL */
  LSFT_TAB, LCTL_BSP, RALT_LBC,
  RALT_RBC, LGUI_LBK, RGUI_RBK, RCTL_ENT,
...
//                                    LSFT_TAB,LCTL_BSP,                       RCTL_SPC,RSFT_ENT, 
  ...
  [_CHORDS] = LAYOUT_6x6(
     ...
     LYR_CYC,CRD_OPN,CRD_DOT,CRD_CTL,CRD_SFT,CRD_QOT,                         CRD_QOT,CRD_SFT,CRD_CTL,CRD_DOT,CRD_OPN,KC_BSLASH,
                     CRD_NBS,CRD_NHS,                                                      CRD_NHS,CRD_NBS,
                                      KC_BSPC,KC_CD_5,                         KC_CD_5,KC_BSPC,
                                      KC_TAB ,KC_ENT,                          KC_ENT ,KC_TAB,
  ...
  [_GAMING] = LAYOUT_6x6(
    ...
    [_APL] = LAYOUT_6x6(
       ...
       APL_QQT, APL_1 , APL_2 , APL_3 , APL_4 , APL_5 ,                         APL_6 , APL_7 , APL_8 , APL_9 , APL_0 ,APL_DSH,
